...
5px 0 20px;background:url(/elearning/theme/image.php/bcu/core/1699952798/t/expanded) 2px center no-repeat}.path-mod-assign.jsenabled .mod-assign-history-link-closed{padding:0
5px 0 20px;background:url(/elearning/theme/image.php/bcu/core/1699952798/t/collapsed) 2px center no-repeat}.path-mod-assign.dir-rtl.jsenabled .mod-assign-history-link-closed{padding:0
20px 0 5px;background:url(/elearning/theme/image.php/bcu/core/1699952798/t/collapsed_rtl) 2px center no-repeat}.path-mod-assign
...
.path-mod-forum .discussion-nav .prev-discussion{float:left}.path-mod-forum .preload-subscribe{background:url(/elearning/theme/image.php/bcu/mod_forum/1699952798/t/subscribed) no-repeat -9999px -9999px}.path-mod-forum .preload-unsubscribe{background:url(/elearning/theme/image.php/bcu/mod_forum/1699952798/t/unsubscribed) no-repeat -9999px -9999px}.path-mod-forum
...
.printicon{background:url(/elearning/theme/image.php/bcu/core/1699952798/t/print) no-repeat scroll 2px center transparent;padding-left:20px}#page-mod-imscp-view
...
.trafficlight{background:url(/elearning/theme/image.php/bcu/quiz/1699952798/navflagged) no-repeat top right}.path-mod-quiz .qnbutton.blocked,
...
.printicon{background:url(/elearning/theme/image.php/bcu/core/1699952798/t/print) no-repeat scroll 2px center transparent;padding-left:20px}#page-mod-wiki-prettyview
...
li{background-image:url(/elearning/theme/image.php/bcu/mod_workshop/1699952798/userplan/task-todo);background-position:top left;background-repeat:no-repeat;list-style-type:none;min-height:16px;margin: .3em 0}.path-mod-workshop .userplan tr.phasetasks
li.completed{background-image:url(/elearning/theme/image.php/bcu/mod_workshop/1699952798/userplan/task-done)}.path-mod-workshop .userplan tr.phasetasks
li.fail{background-image:url(/elearning/theme/image.php/bcu/mod_workshop/1699952798/userplan/task-fail)}.path-mod-workshop .userplan tr.phasetasks
li.info{background-image:url(/elearning/theme/image.php/bcu/mod_workshop/1699952798/userplan/task-info)}.path-mod-workshop .userplan tr.phasetasks
...
0 4px;padding:0px;width:100px;height:20px;position:relative;background:url(/elearning/theme/image.php/bcu/core/1699952798/i/star-rating) top left repeat-x;float:left}#page-blocks-community-communitycourse .star-rating
li{padding:0px;margin:0px;height:20px;width:20px;float:left}#page-blocks-community-communitycourse .star-rating li.current-rating{background:url(/elearning/theme/image.php/bcu/core/1699952798/i/star-rating) left bottom;position:absolute;height:20px;display:block;text-indent:-9000px;z-index:1}#page-blocks-community-communitycourse
...
.message{float:left}#mynotes-opener{position:absolute;bottom:0px;background:#435;width:25px;height:25px}div.mdl-align{min-height:470px}.mynotes-pos-inline-text{padding:10px;margin-left:35px;cursor:pointer}.mynotes-pos-inline,.mynotes-pos-rb,.mynotes-pos-lb,.mynotes-pos-rt,.mynotes-pos-lt{width:40px;height:40px;position:fixed;background:#b31b1b;padding:0;border-radius:30px;text-align:center}.mynotes-pos-rb{bottom:5px;right:20px}.mynotes-pos-lb{bottom:5px;left:20px}.mynotes-pos-rt{top:100px;right:20px}.mynotes-pos-lt{top:100px;left:20px}.mynotes-pos-inline{position:relative;float:left}.mynotes-pos-inline>span.pencil,.mynotes-pos-rb>span.pencil,.mynotes-pos-lb>span.pencil,.mynotes-pos-rt>span.pencil,.mynotes-pos-lt>span.pencil{color:#fff;font-size:29px;margin:0;display:inline-block;font-weight:bold;cursor:pointer;line-height:40px}.mynotes_base{display:inline-block;width:100%}.mynotes_base
.inputarea{background:#fff4d5;padding:5px;margin-bottom:10px}.mynotes_base .inputarea
p{margin:0;font-size:13px}.mynotes_base
.textarea{border:1px
solid gray;padding:5px;background:#fff}.mynotes_base textArea:focus{border:none;box-shadow:none}.mynotes_base
textArea{width:100%;max-width:100%;margin:0;padding:0;max-height:125px;border:none;box-shadow:none}.mynotes_base input[type="submit"], .mynotes_base input[type="submit"]:hover{margin:0;padding:3px
10px;border:none;background:#63ab36;color:#fff}.mynotes_base input[type="submit"][disabled="disabled"]:hover{background:#63ab36;cursor:not-allowed}.mynotes_base
span.warning{color:#bd3c2f;margin-left:15px}.mynotes_base
.responsetext{color:#33b733;line-height:20px}.mynotes_base .tabs-menu{height:30px;float:left;clear:both;margin-bottom:1px}.mynotes_base .tabs-menu
li{padding:0
10px;margin-right:1px;height:30px;line-height:30px;float:left;list-style:none;background-color:#d84e36;cursor:pointer}.mynotes_base .tabs-menu li:first-child{border-radius:7px 0 0 0}.mynotes_base .tabs-menu li:last-child{border-radius:0 7px 0 0}.mynotes_base .tabs-menu
li.current{position:relative;background-color:#ffe6a4;border-bottom:1px solid #fff;z-index:5;border-bottom:2px solid #ffe6a4}.mynotes_base .tabs-menu li:first-child.current{border-left:1px solid #d4d4d1;border-top:1px solid #d4d4d4}.mynotes_base .tabs-menu li:last-child.current{border-right:1px solid #d4d4d1;border-top:1px solid #d4d4d4}.mynotes_base .tabs-menu li .menu-item{text-transform:uppercase;color:#fff;text-decoration:none}.mynotes_base .tabs-menu .current .menu-item{color:#000}.mynotes_base
.tab{border:1px
solid #d4d4d1;clear:both;width:auto;background:#f7f7f4}.mynotes_base .tab .tab-content{display:none}.mynotes_base .tab .tab-content .notes-info{background:#ffe6a4;padding:5px;position:relative}.mynotes_base .tab .tab-content .notes-info
.count{color:#000}.mynotes_base .tab .tab-content .notes-info .mynotes-paging{position:absolute;right:0}.mynotes_base .tab .tab-content .notes-info .mynotes-paging .paging
a{margin:5px;background:#c1621e;padding:4px
10px;border-radius:15px;color:#fff}.mynotes_base .tab .tab-content .notes-info .mynotes-paging .paging
.separator{border-left:1px solid gray}.mynotes_base .tab .tab-content
ul.mynotes_lists{margin:0;clear:both}.mynotes_base .tab .tab-content ul.mynotes_lists
li{list-style:none;position:relative;margin:0
0 5px 0;padding:5px;list-style:none;background-color:#fff;border-top:1px solid #e3e4e4}.mynotes_base .tab .tab-content ul.mynotes_lists li
.content{margin-right:10px;word-wrap:break-word}.mynotes_base .tab .tab-content ul.mynotes_lists li .note-detail{display:inline-block;font-size:11px}.mynotes_base .tab .tab-content ul.mynotes_lists li
.time{color:#888;font-style:italic;display:inline-block;margin-left:5px;font-size:11px}.mynotes_base .tab .tab-content ul.mynotes_lists li a.mynote-delete{position:absolute;right:0;margin:0
4px}.mynotes_base .tab .tab-content ul.mynotes_lists li a.mynote-delete
span{color:#bbb}.block_myprofile
...
.tree_item.branch{padding-left:21px;cursor:pointer;background-image:url('/elearning/theme/image.php/bcu/core/1699952798/t/expanded')}.block_navigation .block_tree
.tree_item.emptybranch{padding-left:21px;background-image:url('/elearning/theme/image.php/bcu/core/1699952798/t/collapsed_empty')}.block_navigation .block_tree
.tree_item.loadingbranch{background-image:url('/elearning/theme/image.php/bcu/core/1699952798/i/loading_small')}.block_navigation .block_tree .tree_item
...
.tree_item.branch{background-image:url('/elearning/theme/image.php/bcu/core/1699952798/t/collapsed')}.jsenabled
...
.tree_item.emptybranch{padding-right:21px;padding-left:0;background-image:url('/elearning/theme/image.php/bcu/core/1699952798/t/collapsed_empty_rtl')}.dir-rtl .block_navigation .block_tree .tree_item
...
.tree_item.branch{background-image:url('/elearning/theme/image.php/bcu/core/1699952798/t/collapsed_rtl')}.block_online_users .content .list
...
.tree_item.branch{background-image:url(/elearning/theme/image.php/bcu/core/1699952798/t/expanded);background-position:0 10%;background-repeat:no-repeat}.block_settings .block_tree
.root_node.leaf{padding-left:0px}.block_settings .block_tree
.active_tree_node{font-weight:bold}.jsenabled .block_settings .block_tree
.tree_item.branch{cursor:pointer}.jsenabled .block_settings .block_tree
.tree_item.emptybranch{background-image:url(/elearning/theme/image.php/bcu/core/1699952798/t/collapsed_empty);background-position:0 10%;background-repeat:no-repeat}.jsenabled .block_settings .block_tree .collapsed
ul{display:none}.jsenabled .block_settings .block_tree .collapsed
.tree_item.branch{background-image:url(/elearning/theme/image.php/bcu/core/1699952798/t/collapsed)}.ie6 .block_settings .block_tree
...
.tree_item.branch.loadingbranch{background-image:url(/elearning/theme/image.php/bcu/core/1699952798/i/loading_small)}.jsenabled.dir-rtl .block_settings .block_tree
.tree_item.emptybranch{background-image:url(/elearning/theme/image.php/bcu/core/1699952798/t/collapsed_empty_rtl);background-position:center right}.jsenabled.dir-rtl .block_settings .block_tree .collapsed
.tree_item.branch{background-image:url(/elearning/theme/image.php/bcu/core/1699952798/t/collapsed_rtl)}.block_site_main_menu
...
.coursetag_list{}.icon1-download-pdf1{background-image:url(/elearning/theme/image.php/bcu/theme/1699952798/icon-pdf) !important;background-repeat:no-repeat !important;width:23px !important;height:26px !important;background-position:0 0 !important}.text-download-common1{padding-left:37px !important;padding-top:7px !important;position:absolute !important}.icon1-download1{background-image:url(/elearning/theme/image.php/bcu/theme/1699952798/download-icon) !important;background-repeat:no-repeat !important;width:18px !important;height:28px !important;background-position:40px 0 !important}.icon1-download-flash1{background-image:url(/elearning/theme/image.php/bcu/theme/1699952798/icon-flash) !important;background-repeat:no-repeat !important;width:22px !important;height:25px !important;background-position:0 0 !important}.icon1-download-firefox1{background-image:url(/elearning/theme/image.php/bcu/theme/1699952798/icon-firefox) !important;background-repeat:no-repeat !important;width:23px !important;height:24px !important;background-position:0 0 !important}.icon1-download-ie91{background-image:url(/elearning/theme/image.php/bcu/theme/1699952798/ie9) !important;background-repeat:no-repeat !important;width:23px !important;height:21px !important;background-position:0 0 !important}.icon1-download-chrome1{background-image:url(/elearning/theme/image.php/bcu/theme/1699952798/crome) !important;background-repeat:no-repeat !important;width:23px !important;height:22px !important;background-position:0 0 !important}.icon1-download-java1{background-image:url(/elearning/theme/image.php/bcu/theme/1699952798/sun-java);background-repeat:no-repeat;width:21px;height:29px;background-position:0 0}.pad5{padding:5px
0}.mycourses-link-online{border-radius:4px;margin:2px
1px;color:#222;display:block;margin:2px
15px;width:88%;background-image:-ms-linear-gradient(top, #e35f00 0%, #F38E45 100%);background-image:-moz-linear-gradient(top, #e35f00 0%, #F38E45 100%);background-image:-o-linear-gradient(top, #e35f00 0%, #F38E45 100%);background-image:-webkit-gradient(linear, left top, left bottom, color-stop(0, #e35f00), color-stop(100, #F38E45));background-image:-webkit-linear-gradient(top, #e35f00 0%, #F38E45 100%);background-image:linear-gradient(to bottom, #e35f00 0%, #F38E45 100%);-webkit-box-shadow:0px 1px 2px 0px rgba(50, 50, 50, 0.46);-moz-box-shadow:0px 1px 2px 0px rgba(50, 50, 50, 0.46);box-shadow:0px 1px 2px 0px rgba(50, 50, 50, 0.46)}.mycourses-link-online
a{display:block;padding:10px
20px;text-decoration:none}.mycourses-link-online a:hover{background-color:#ff6b01;border-radius:4px;text-decoration:none;-webkit-box-shadow:0px 1px 2px 0px rgba(50, 50, 50, 0.46);-moz-box-shadow:0px 1px 2px 0px rgba(50, 50, 50, 0.46);box-shadow:0px 1px 2px 0px rgba(50,50,50,0.46)}.mycourses-icon-online{display:table-cell;vertical-align:middle;width:34px}.mycourses-icon-online
img{width:100%}.mycourses-type-online{display:table-cell;text-align:left;vertical-align:middle;padding-left:15px;font-size:16px;color:#fff}@media (max-width: 1024px){.mycourses-type-online{font-size:16px}.mycourses-link-online{width:88%;margin:0
auto}}@media (max-width: 768px){.mycourses-link-online{width:88%;margin:0
auto}}@media (max-width: 736px){.mycourses-link-online{width:88%;margin:0
auto}}#glossaryfilteroverlayprogress{position:fixed;top:50%;width:100%;text-align:center}.jsenabled
...
img.icon{padding:0;vertical-align:baseline}.CurrentStudy-Bar-wrapper{width:163px;height:10px;margin-bottom:2px}.CurrentStudy-Bar-bdr{width:163px;border:1px
solid #f78d51}.CurrentStudy-Bar-100{background-image:url(/elearning/theme/image.php/bcu/theme/1699952798/bar01);background-position:1px 50%;background-repeat:repeat-x;height:10px;margin-top:0;width:100%;margin-left:0px}.CurrentStudy-Bar-60{background-image:url(/elearning/theme/image.php/bcu/theme/1699952798/bar01);background-position:1px 50%;background-repeat:repeat-x;height:10px;margin-top:0;width:60%}.CurrentStudy-Bar-40{background-image:url(/elearning/theme/image.php/bcu/theme/1699952798/bar01);background-position:1px 50%;background-repeat:repeat-x;height:10px;margin-top:0;width:40%}.CurrentStudy-Bar-20{background-image:url(/elearning/theme/image.php/bcu/theme/1699952798/bar01);background-position:1px 50%;background-repeat:repeat-x;height:10px;margin-top:0;width:20%}.menubtnbox{width:100%;display:block;font-family:Arial,sans-serif}.mycourses-link{border-radius:4px;margin:2px
1px;color:#222;display:inline-block;width:24%;background-image:-ms-linear-gradient(top, #e35f00 0%, #F38E45 100%);background-image:-moz-linear-gradient(top, #e35f00 0%, #F38E45 100%);background-image:-o-linear-gradient(top, #e35f00 0%, #F38E45 100%);background-image:-webkit-gradient(linear, left top, left bottom, color-stop(0, #e35f00), color-stop(100, #F38E45));background-image:-webkit-linear-gradient(top, #e35f00 0%, #F38E45 100%);background-image:linear-gradient(to bottom, #e35f00 0%, #F38E45 100%);-webkit-box-shadow:0px 1px 2px 0px rgba(50, 50, 50, 0.46);-moz-box-shadow:0px 1px 2px 0px rgba(50, 50, 50, 0.46);box-shadow:0px 1px 2px 0px rgba(50, 50, 50, 0.46)}.mycourses-link
a{display:block;padding:10px
20px;text-decoration:none}.mycourses-link a:hover{background-color:#ff6b01;border-radius:4px;-webkit-box-shadow:0px 1px 2px 0px rgba(50, 50, 50, 0.46);-moz-box-shadow:0px 1px 2px 0px rgba(50, 50, 50, 0.46);box-shadow:0px 1px 2px 0px rgba(50,50,50,0.46)}.mycourses-icon{display:table-cell;vertical-align:middle;width:34px}.mycourses-icon
img{width:100%}.mycourses-type{display:table-cell;text-align:left;vertical-align:middle;padding-left:15px;font-size:16px;color:#fff}@media (max-width: 1024px){.mycourses-type{font-size:16px}.mycourses-link{width:32%}}@media (max-width: 768px){.mycourses-link{width:49%}}@media (max-width: 736px){.mycourses-link{width:100%}}#section-0 li.modtype_page
input{display:none}div.no-overflow{word-wrap:break-word;padding-right:15px}.format-singleactivity .tree_item.orphaned
...
svg{direction:ltr}.admin_note{font-size:0.8em;color:#c10031}.report-eventlist-name{color:#888;font-size:0.75em}.report-eventlist-datatable-table>div>table{width:100%}#page-admin-report-eventlist-index
...
input{width:20px;height:16px;background:transparent url(/elearning/theme/image.php/bcu/core/1699952798/t/delete) no-repeat center top;margin-top:4px}.gradingform_guide.editor .moveup
input{width:20px;height:15px;background:transparent url(/elearning/theme/image.php/bcu/core/1699952798/t/up) no-repeat center top;margin-top:4px}.gradingform_guide.editor .movedown
input{width:20px;height:15px;background:transparent url(/elearning/theme/image.php/bcu/core/1699952798/t/down) no-repeat center top;margin-top:4px}.gradingform_guide.editor .addcriterion input,
.gradingform_guide.editor .addcomment
input{background:transparent url(/elearning/theme/image.php/bcu/core/1699952798/t/add) no-repeat;display:block;color:#555;font-weight:bold;text-decoration:none}.gradingform_guide.editor .addcriterion input,
.gradingform_guide.editor .addcomment
...
.markingguidecomment{cursor:pointer}.jsenabled .gradingform_guide .markingguidecomment:before{content:url(/elearning/theme/image.php/bcu/core/1699952798/t/add);padding-right:2px}.dir-rtl.jsenabled .gradingform_guide .markingguidecomment:before{padding-right:0;padding-left:2px}.gradingform_guide
...
input{width:12px;height:12px;background:transparent url(/elearning/theme/image.php/bcu/core/1699952798/t/delete) no-repeat center top;margin: .3em .3em 0 .3em}.gradingform_rubric.editor .levels .level .delete
input{width:12px;height:16px;background:transparent url(/elearning/theme/image.php/bcu/core/1699952798/t/delete) no-repeat center center}.dir-rtl .gradingform_rubric.editor .levels .level .delete
input{margin-right: .45em;margin-left:0}.gradingform_rubric.editor .moveup
input{width:12px;height:12px;background:transparent url(/elearning/theme/image.php/bcu/core/1699952798/t/up) no-repeat center top;margin: .3em .3em 0 .3em}.gradingform_rubric.editor .movedown
input{width:12px;height:12px;background:transparent url(/elearning/theme/image.php/bcu/core/1699952798/t/down) no-repeat center top;margin: .3em .3em 0 .3em}.gradingform_rubric.editor .addcriterion input,
.gradingform_rubric.editor .addlevel
input{background:transparent url(/elearning/theme/image.php/bcu/core/1699952798/t/add) no-repeat top left;display:block;color:#555;font-weight:bold;text-decoration:none}.gradingform_rubric.editor .addcriterion
...
.collapseexpand{padding-left:20px;background:url(/elearning/theme/image.php/bcu/core/1699952798/t/collapsed) 2px center no-repeat}.dir-rtl .collapsible-actions
.collapseexpand{padding-right:20px;padding-left:0;background:url(/elearning/theme/image.php/bcu/core/1699952798/t/collapsed_rtl) right center no-repeat}.collapsible-actions .collapse-all,.dir-rtl .collapsible-actions .collapse-all{background-image:url(/elearning/theme/image.php/bcu/core/1699952798/t/expanded)}.yui-overlay .yui-widget-bd{position:relative;top:0;left:0;z-index:1;padding:2px
...
.smartselect_submenuitem{background-image:url(/elearning/theme/image.php/bcu/core/1699952798/t/collapsed);background-position:100%;background-repeat:no-repeat}.smartselect.spanningmenu
...
.closebutton{display:inline-block;float:right;width:25px;height:15px;padding:0;vertical-align:middle;cursor:pointer;background-image:url(/elearning/theme/image.php/bcu/theme/1699952798/sprite);background-repeat:no-repeat;border-style:none}.dir-rtl .moodle-dialogue-base .moodle-dialogue-wrap .moodle-dialogue-hd .yui3-widget-buttons{right:auto;left:0}.moodle-dialogue-base .moodle-dialogue .moodle-dialogue-bd{padding:1em;font-size:12px;line-height:2em;color:#555}.moodle-dialogue-base .moodle-dialogue-wrap .moodle-dialogue-content{padding:0;background:#FFF}.moodle-dialogue-base .moodle-dialogue-fullscreen .moodle-dialogue-hd{padding:10px;font-size:16px}.moodle-dialogue-base .moodle-dialogue-fullscreen .moodle-dialogue-content{position:absolute;top:0;right:0;bottom:50px;left:0;margin:0;overflow:auto;border:0}.moodle-dialogue-base .moodle-dialogue-fullscreen .moodle-dialogue-hd,.moodle-dialogue-base .moodle-dialogue-fullscreen .moodle-dialogue-wrap{border-radius:0}.moodle-dialogue-confirm .confirmation-dialogue{text-align:center}.moodle-dialogue-confirm .confirmation-dialogue
...
.ajaxworking{position:absolute;top:3px;right:22px;width:16px;height:16px;background:url(/elearning/theme/image.php/bcu/core/1699952798/i/ajaxloader) no-repeat}.dir-rtl.path-course-view
...
a{display:block;padding-left:21px;background-image:url(/elearning/theme/image.php/bcu/core/1699952798/i/course);background-position:left .2em;background-repeat:no-repeat}.dir-rtl .coursebox>.info>.coursename
...
a{background-image:url(/elearning/theme/image.php/bcu/core/1699952798/i/mnethost)}.dir-rtl .coursebox>.info>.categoryname
...
6px 1px 27px;background:#fff url('/elearning/theme/image.php/bcu/core/1699952798/a/search') no-repeat 7px 7px;border:1px
...
solid black}.file-picker .fp-pathbar{display:table-row}.fp-pathbar.empty{display:none}.fp-pathbar .fp-path-folder{width:27px;height:12px;margin-left:4px;background:url('/elearning/theme/image.php/bcu/theme/1699952798/fp/path_folder') no-repeat 0 0}.dir-rtl .fp-pathbar .fp-path-folder{width:auto;height:12px;margin-left:4px;background:url('/elearning/theme/image.php/bcu/theme/1699952798/fp/path_folder_rtl') no-repeat right top}.dir-rtl .fp-pathbar
...
.ygtvtn{width:17px;height:22px;background:url('/elearning/theme/image.php/bcu/core/1699952798/y/tn') 0 0 no-repeat}.dir-rtl .filemanager .ygtvtn,.dir-rtl .file-picker
.ygtvtn{width:17px;height:22px;background:url('/elearning/theme/image.php/bcu/core/1699952798/y/tn_rtl') 0 0 no-repeat}.file-picker .ygtvtm,.filemanager
.ygtvtm{width:13px;height:12px;cursor:pointer;background:url('/elearning/theme/image.php/bcu/core/1699952798/y/tm') 0 10px no-repeat}.file-picker .ygtvtmh,.filemanager
.ygtvtmh{width:13px;height:12px;cursor:pointer;background:url('/elearning/theme/image.php/bcu/core/1699952798/y/tm') 0 10px no-repeat}.file-picker .ygtvtp,.filemanager
.ygtvtp{width:13px;height:12px;cursor:pointer;background:url('/elearning/theme/image.php/bcu/core/1699952798/y/tp') 0 10px no-repeat}.dir-rtl .file-picker .ygtvtp,.dir-rtl .filemanager
.ygtvtp{background:url('/elearning/theme/image.php/bcu/core/1699952798/y/tp_rtl') 0 10px no-repeat}.file-picker .ygtvtph,.filemanager
.ygtvtph{width:13px;height:22px;cursor:pointer;background:url('/elearning/theme/image.php/bcu/core/1699952798/y/tp') 0 10px no-repeat}.dir-rtl .file-picker .ygtvtph,.dir-rtl .filemanager
.ygtvtph{background:url('/elearning/theme/image.php/bcu/core/1699952798/y/tp_rtl') 0 10px no-repeat}.file-picker .ygtvln,.filemanager
.ygtvln{width:17px;height:22px;background:url('/elearning/theme/image.php/bcu/core/1699952798/y/ln') 0 0 no-repeat}.dir-rtl .file-picker .ygtvln,.dir-rtl .filemanager
.ygtvln{background:url('/elearning/theme/image.php/bcu/core/1699952798/y/ln_rtl') 0 0 no-repeat}.file-picker .ygtvlm,.filemanager
.ygtvlm{width:13px;height:12px;cursor:pointer;background:url('/elearning/theme/image.php/bcu/core/1699952798/y/lm') 0 10px no-repeat}.file-picker .ygtvlmh,.filemanager
.ygtvlmh{width:13px;height:12px;cursor:pointer;background:url('/elearning/theme/image.php/bcu/core/1699952798/y/lm') 0 10px no-repeat}.file-picker .ygtvlp,.filemanager
.ygtvlp{width:13px;height:12px;cursor:pointer;background:url('/elearning/theme/image.php/bcu/core/1699952798/y/lp') 0 10px no-repeat}.dir-rtl .file-picker .ygtvlp,.dir-rtl .filemanager
.ygtvlp{background:url('/elearning/theme/image.php/bcu/core/1699952798/y/lp_rtl') 0 10px no-repeat}.file-picker .ygtvlph,.filemanager
.ygtvlph{width:13px;height:12px;cursor:pointer;background:url('/elearning/theme/image.php/bcu/core/1699952798/y/lp') 0 10px no-repeat}.dir-rtl .file-picker .ygtvlph,.dir-rtl .filemanager
.ygtvlph{background:url('/elearning/theme/image.php/bcu/core/1699952798/y/lp_rtl') 0 10px no-repeat}.file-picker .ygtvloading,.filemanager
.ygtvloading{width:16px;height:22px;background:transparent url('/elearning/theme/image.php/bcu/core/1699952798/y/loading') 0 0 no-repeat}.file-picker .ygtvdepthcell,.filemanager
.ygtvdepthcell{width:17px;height:32px;background:url('/elearning/theme/image.php/bcu/core/1699952798/y/vline') 0 0 no-repeat}.file-picker .ygtvblankdepthcell,.filemanager
...
dashed #6c8cd3}.dndupload-message{display:none}.dndsupported .dndupload-message{display:inline}.dnduploadnotsupported-message{display:none}.dndnotsupported .dnduploadnotsupported-message{display:inline}.dndupload-target{display:none}.dndsupported .dndupload-ready .dndupload-target{display:block}.dndupload-uploadinprogress{display:none;text-align:center}.dndupload-uploading .dndupload-uploadinprogress{display:block}.dndupload-arrow{position:absolute;top:5px;width:100%;height:80px;background:url(/elearning/theme/image.php/bcu/theme/1699952798/fp/dnd_arrow) center no-repeat}.fitem.disabled .filepicker-container,.fitem.disabled .fm-empty-container{display:none}.dndupload-progressbars{display:none;padding:10px}.dndupload-inprogress .dndupload-progressbars{display:block}.dndupload-inprogress .fp-content{display:none}.filemanager.fm-noitems .dndupload-inprogress .fm-empty-container{display:none}.filepicker-filelist.dndupload-inprogress .filepicker-container{display:none}.filepicker-filelist.dndupload-inprogress
...
a.fheader{padding:0
5px 0 20px;margin-left:-20px;background:url(/elearning/theme/image.php/bcu/core/1699952798/t/expanded) 2px center no-repeat}.dir-rtl .mform fieldset.collapsible legend
a.fheader{padding:0
20px 0 5px;margin-right:-20px;margin-left:0;background-position:right center}.mform fieldset.collapsed legend
a.fheader{background-image:url(/elearning/theme/image.php/bcu/core/1699952798/t/collapsed)}.dir-rtl .mform fieldset.collapsed legend
a.fheader{background-image:url(/elearning/theme/image.php/bcu/core/1699952798/t/collapsed_rtl)}.jsenabled .mform .collapsed
...
input{padding-left:26px;margin:0;line-height:inherit;color:inherit;text-shadow:inherit;background:transparent url(/elearning/theme/image.php/bcu/core/1699952798/t/add) no-repeat 7px 8px;border:0
...
td{padding-right:0;padding-left:0}}.dir-rtl .dropdown-menu{right:0;left:auto;margin-right:0}.dir-rtl .navbar .nav>li>.dropdown-menu:before{right:9px;left:auto}.dir-rtl .navbar .nav>li>.dropdown-menu:after{right:10px;left:auto}.dir-rtl .dropdown-submenu>a:after{float:left;margin-right:0;margin-left:-10px;border-right-color:#ccc;border-left-color:transparent;border-width:5px 5px 5px 0}.dir-rtl .dropdown-submenu>.dropdown-menu{right:100%;left:auto}@media(max-width:979px){.nav-collapse{height:0}.nav-collapse .nav>li>a{color:#333}.nav-collapse .nav>li>a:hover,.nav-collapse .nav>li>a:focus,.nav-collapse .dropdown-menu a:hover,.nav-collapse .dropdown-menu a:focus,.nav-collapse .dropdown-submenu a:hover,.nav-collapse .dropdown-submenu a:focus,.nav-collapse .dropdown-submenu a:active,.nav-collapse .dropdown-menu>li>a:hover,.nav-collapse .dropdown-menu>li>a:focus,.nav-collapse .dropdown-submenu:hover>a,.nav-collapse .dropdown-submenu:focus>a{color:#333;background-image:none}.nav-collapse.in{height:auto}.nav-collapse.in .usermenu .moodle-actionmenu[data-enhanced] .toggle-display{display:none}.nav-collapse.in .usermenu .moodle-actionmenu[data-enhanced] .menu{display:block}.nav-collapse.in .usermenu .moodle-actionmenu[data-enhanced] .menu
li{margin:0
...
0px 10px;font-family:'Open Sans',sans-serif}a:link,
a:visited, .tabtree .tabrow0 li a,.dropdown-menu.usermen>li>a{color:#002f67;text-decoration:none}a:hover,a:active{color:#ffa462;text-decoration:underline}a:active{outline:0}a:focus{outline:5px
...
h2{font-size:2.291em;color:#5f588a;font-weight:bold}.headingblock, h2.main, #site-news-forum h2, #frontpage-course-list h2, #frontpage-category-names h2, #frontpage-category-combo h2, .course_category_tree .category>.info>.categoryname{color:#0f529f;font-size:23px;border-bottom:0px solid #eee;font-weight:normal;margin-bottom:10px}#nologo, #nologo a, .generalbox h2, h3.sectionname, div.tabtree li.selected a span, .forumpost .subject, .blog_entry div.subject a, h2.headingblock, h2.main, h3.main, h2.main a, h3.main a, div.loginpanel h2, div.signuppanel
h2{font-weight:bold}#page{clear:both;margin:0
0;padding:0
0;max-width:inherit}#page-header-wrapper{background:#01244e;width:100%;z-index:2}#above-header{height:20px;padding-top:5px;padding-bottom:5px}#above-header
...
.span3{text-align:right;padding-top:35px}#page-footer{background:#f5f5f5;margin:10px
0px 0;text-align:center;color:#000;border-top:1px solid #ccc;font-size:100%}#page-footer .block-list>li{padding:0.3em 0}.block-list>li{line-height:1.2}.white li a, .base-tabs a.white, .block-list
...
solid transparent;font-size:13px;background:#fff url(/elearning/theme/image.php/bcu/theme/1699952798/ajax-loader) no-repeat 50% 95%;padding:20px
20px 40px}#forummenu
...
.generaltable{display:block;overflow-x:auto;overflow-y:visible}div.no-overflow,.yui3-datatable{overflow-y:visible;overflow-x:hidden}.paging{word-wrap:break-word}.path-course-view
.completionprogress{z-index:2}.searchbox{text-align:right;padding-top:45px}.greybox{border:1px
...
.summary{min-height:50px;overflow:auto;position:absolute;text-align:center;color:#B7B3EF !important;padding:15px;top:0px;left:0px;display:none}.coursebox.panel.hover .panel-body:hover .coursebox-content h3
a{color:#B7B3EF !important}.coursebox.hover .teachers li a, .coursebox.hover .summary > a:link, .coursebox.hover .summary>a:visited{color:#B7B3EF !important}.coursebox.hover
.teachers{text-align:left;padding-top:2px;padding-left:2px}.coursebox.hover:hover
.summary{height:auto;width:auto;min-width:90%;min-height:50px;display:block}.coursebox.panel.hover .panel-body:hover{background:#44318D !important;-webkit-transition:all .5s ease-in-out;-moz-transition:all .5s ease-in-out;-o-transition:all .5s ease-in-out;transition:all .5s ease-in-out}.coursebox.panel .panel-body:hover
...
input{width:20px;height:16px;background:transparent url(/elearning/theme/image.php/bcu/core/1699952798/t/delete) no-repeat center top;margin-top:4px}.gradingform_guide.editor .moveup
input{width:20px;height:15px;background:transparent url(/elearning/theme/image.php/bcu/core/1699952798/t/up) no-repeat center top;margin-top:4px}.gradingform_guide.editor .movedown
input{width:20px;height:15px;background:transparent url(/elearning/theme/image.php/bcu/core/1699952798/t/down) no-repeat center top;margin-top:4px}.gradingform_guide.editor .moveup input:hover{background:#00aeef url(/elearning/theme/image.php/bcu/core/1699952798/t/up) no-repeat center top}.gradingform_guide.editor .movedown input:hover{background:#00aeef url(/elearning/theme/image.php/bcu/core/1699952798/t/up) no-repeat center top}.gradingform_guide.editor .controls .delete input:hover{background:#00aeef url(/elearning/theme/image.php/bcu/core/1699952798/t/up) no-repeat center top}.gradingform_guide.editor .addcriterion input, .gradingform_guide.editor .addcomment
...
.performanceinfo{margin:10px
0}.purgecaches a:link{color:#FFF}.helplink{text-align:center}.helplink>a{color:#FFF}#logo11{display:block;float:left;padding:14px
0;height:66px;width:412px}.headermenu{padding-top:13px}.menu-divider-padding{padding:0
5px}.header-phone-number{color:#fff !important;font-size:20px;font-weight:bold}.padright10{padding-right:10px}.grey-text-color{color:#4f4f4f}.login-panel{background-color:#f5f5f5;height:360px;border-radius:10px}.login-title{background-color:#032d5d;padding:10px
0 10px 25px;border-radius:10px 10px 0 0;color:#f2f2f2;font-size:18px;font-weight:normal}.login-welcome-text{font-size:24px;font-weight:normal;padding-bottom:10px}.login-button{background-color:#e35f00;color:#f2f2f2;font-size:16px}.icons-loginpage{display:inline-block;margin:0
20px}.login-icons{width:90%;padding-bottom:10px}.martop10{margin-top:10px}.marbot10{margin-bottom:10px}.martop60{margin-top:60px}.login-bottom-banner{display:block;max-width:100%;height:auto;margin:0
auto}#loginbtn{border-radius:8px;box-shadow:none}.banner-my-courses{width:100%;height:335px}h2.headingblock{font-weight:normal;color:#0f529f}.block_calendar_month table.minicalendar.calendartable
td.day{border:1px
solid #fff !important;width:20px}#page .course-content ul
li.section.main{margin-bottom:12px !important}.course-content ul.topics
li.section{padding-bottom:0 !important}.landing-banner{background-image:url(/elearning/theme/image.php/bcu/theme/1699952798/banner-landngpage);margin-bottom:8px;background-color:#364f6e;height:335px;width:100%;box-sizing:border-box}.search-course-panel{background-color:#c46626;height:275px;border-radius:10px;width:100%}.search-course-title{color:#fff;font-size:18px;padding:10px
10px}#landing-search
label{font-size:12px}#landing-search input, #landing-search textarea, #landing-search
select{background:#d6d6d6;box-sizing:border-box;font-size:12px;height:28px;line-height:18px;margin-bottom:8px;width:100%}.martop10{margin-top:10px}.martop20{margin-top:20px}.martop30{margin-top:30px}.martop60{margin-top:60px}.landingpage-left{padding:30px
20px 18px 30px;box-sizing:border-box}.landingpage-right{}.popular-courses{margin-top:42px;color:#fff}.popular-courses-link
ul{font-size:14px;margin:0px
0px 10px;display:initial}.popular-courses-link ul
li{list-style:none;list-style-position:inside;line-height:24px}.popular-courses-link ul li
i{margin-top:7px;float:left;width:5%}.popular-courses-link ul li
a{color:#fff;padding-left:5px;width:90%;float:left;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.table-tka{width:100%}.table-tka.table-bordered>thead>tr>th{border-bottom:1px solid #ddd!important}.table-tka.table-striped tbody > tr:nth-child(2n+1) > td, .table-tka.table-striped tbody>tr:nth-child(2n+1)>th{background:#ebeaea}.table-tka.table-bordered th, .table-tka.table-bordered
td{padding:8px
10px}@media (min-width: 768px) and (max-width: 991px){.icons-loginpage{margin:0}.login-welcome-text{font-size:18px;font-weight:normal}.login-icons{width:80%}}@media (min-width: 768px) and (max-width: 991px){.icons-loginpage{margin:0}.login-welcome-text{font-size:18px;font-weight:normal}.login-icons{width:80%}.search-course-title{font-size:15px}#landing-search
label{font-size:11px}}@media (max-width: 1024px){.landingpage-left{width:35%!important;padding:30px
20px}.landingpage-right{width:65%!important;margin-left:0px!important}}@media (max-width: 768px){.landingpage-left{width:100%}.landingpage-right{width:100%}}@media (max-width: 736px){.landingpage-left{width:100%}.landingpage-right{width:100%}}.menubtnbox{display:block}.mycourses-link-land{color:#222;width:25%;float:left;padding:2px
2px 2px;box-sizing:border-box}.mycourses-link-land
a{display:block;padding:10px
20px;text-decoration:none;border-radius:4px;background:#f38e45;background:-moz-linear-gradient(top, #e35f00 0%, #f38e45 100%);background:-webkit-linear-gradient(top, #e35f00 0%, #f38e45 100%);background:linear-gradient(to bottom, #e35f00 0%, #f38e45 100%);-webkit-box-shadow:0px 1px 2px 0px rgba(50, 50, 50, 0.46);-moz-box-shadow:0px 1px 2px 0px rgba(50, 50, 50, 0.46);box-shadow:0px 1px 2px 0px rgba(50,50,50,0.46);-webkit-border-radius:4px;-moz-border-radius:4px;border-radius:4px}.mycourses-link-land:first-child{padding-left:0px}.mycourses-link-land:last-child{padding-right:0px}.mycourses-link-land a:hover{background-color:#ff6b01;background-image:none;-webkit-border-radius:4px;-moz-border-radius:4px;border-radius:4px;-webkit-box-shadow:0px 1px 2px 0px rgba(50, 50, 50, 0.46);-moz-box-shadow:0px 1px 2px 0px rgba(50, 50, 50, 0.46);box-shadow:0px 1px 2px 0px rgba(50,50,50,0.46)}.mycourses-icon{display:table-cell;vertical-align:middle;width:34px}.mycourses-icon
img{width:100%}.mycourses-type{display:table-cell;text-align:left;vertical-align:middle;padding-left:12px;font-size:16px;color:#fff}@media (max-width: 1024px){.mycourses-type{font-size:16px}.mycourses-link-land{width:25%}}@media (max-width: 768px){.mycourses-link-land{width:50%}}@media (max-width: 736px){.mycourses-link-land{width:100%}}.forumpost{border-radius:0;-moz-border-radius:0;-webkit-border-radius:0;border:none;box-shadow:none}.author{border-bottom:1px solid #cfcdce;margin:0
20px;padding-bottom:10px}.forumolddiscuss{text-align:right}.custom-button{background:#e35f00 none repeat scroll 0 0 / 100% 200%;border:0
none;border-radius:8px;box-shadow:none;color:#fff !important;cursor:pointer;padding:8px
15px;text-shadow:none;transition:background 0.2s ease-out 0s}.custom-button:hover{background-color:#ea6902;background-position:0 -100%;color:#fff;text-decoration:none !important}.modal-header
h3{font-weight:normal}#get-started td:nth-child(1){border-top:1px solid #ddd;line-height:20px;padding:5px;text-align:left;vertical-align:text-top;color:#032d5d;font-size:16px;font-weight:bold}#get-started td:nth-child(2){vertical-align:text-top}.editing .course-content ul.topics li.section .content, .editing .course-content ul.weeks li.section
.content{margin:0
0 !important}#edittingbutton
a{background:#e35f00;border-radius:4px;color:#fff;padding:6px}.breadcrumb-button{margin-top:9px}.editing .course-content ul li.section
.side{position:relative;z-index:1}.course-content ul li.section.hidden .sectionname, .course-content ul li.section.hidden .content > div, .course-content ul li.section.hidden .activity
.activityinstance{margin-left:0;margin-right:0}#attempts{border:1px
solid #ddd}#attempts tr
td{border:1px
solid #ddd}.fp-formset
.controls{clear:both}.block_recent_activity .activitydate, .block_recent_activity
.activityhead{text-align:left !important}#id_summary_editoreditable{width:700px;word-wrap:break-word}#page-blocks-configurable_reports-viewreport .generaltable
th.header{background-color:transparent;border-bottom-width:0}#page-login-forgot_password
.mform#mform1{margin-left:25%;width:50%}.block_news_items{display:none !important}.groupmanagementtable #buttonscell p.arrow_button
input{margin:1px
auto !important}.block_tka_get_started
.content{background:transparent !important}.support-class{color:#fff;font-weight:500;margin:8px
0 !important;font-size:13px;position:absolute !important;top:14px !important;padding-left:21px}@media only screen
and (min-device-width : 768px)
and (max-device-width : 1024px)
and (orientation : landscape){.get-started-banner-img{max-width:100%;height:231px}.nav .dropdown-menu li
a{color:#bfbdbd !important}.dropdown-menu{background-color:#2e6eb9}.support-class{top:14px !important}}@media only screen
and (min-device-width : 768px)
and (max-device-width : 1024px)
and (orientation : portrait){.get-started-banner-img{max-width:100%;height:231px}.nav .dropdown-menu li a:hover, .navbar .nav>li>a:hover{background:rgba(255, 255, 255, 0.1) none repeat scroll 0 0;color:#bfbdbd !important}.nav .dropdown-menu li
a{color:#bfbdbd !important}}}@media only screen
and (min-device-width : 1100px){.get-started-banner-img{max-width:100%;height:231px}}@media only screen
and (max-device-width : 980px){.support-class{top:6px !important;right:40px}}.submitbtns{min-height:60px !important}#page-header-wrapper{background:#44318D !important}.navbar{background-color:#44318D !important}.search-course-title{background:#44318D !important;font-weight:700;display:none !important}.header{background:#44318D !important}h2.headingblock{font-weight:normal;color:#e7ebf0 !important}.mycourses-link-land
a{background:#44318D !important}h3.sectionname{background:#44318D !important}#myperformance-overview-grid
th{background:#44318D !important;color:white !important}.linkclasses
a{background-color:#FFD000 !important}.admintable
th{color:white !important}.header
a{color:white !important}.mycourses-link{display:none !important;visibility:hidden !important}.block{border:0px
solid #ccc;padding:0
0;box-shadow:none;background:transparent;border-radius:0px;border:0px
solid #e8eaeb}.block
.header{padding:10px
10px;padding-right:0px;background:#032d5d;border-bottom:0px solid #e8eaeb}.block.hidden
.header{border-bottom:0px}.block .header .title
h2{margin:0
0;padding:0
0;text-transform:none;font-size:15px;color:#fff;margin:0px
0px;font-weight:normal;text-shadow:none}.block
.content{padding:10px
10px;font-weight:normal;font-size:90%;background:#f5f5f5;color:#333}.block .content
...
input{width:70%}.loginbox .loginform .form-input{float:right;width:66%}.loginbox .loginform .form-label{width:30%;padding-top:4px}.block.invisible:hover{opacity:1}.block .block-hider-show, .block .block-hider-hide{width:12px}body.has_dock
...
a{color:#999}#navwrap{clear:both;border-bottom:none}.navbar{clear:none;float:none;margin-bottom:0;min-width:40%;margin-top:4px;padding:3px
0;background-color:#0f52a0}.navbar-inner{background-color:transparent;background-image:none;background-repeat:repeat-x;border:0px
solid #D4D4D4;border-radius:0px 0px 0px 0px;box-shadow:none;min-height:40px;padding-left:0px;padding-right:0px;filter:none;border-top:0px solid #9E1B12;border-bottom:0px solid #9E1B12;box-shadow:none}.navbar .nav>li>a{color:#fff !important;line-height:40px;float:none;padding:0px
20px 0px;text-decoration:none;text-shadow:none;font-weight:400;font-size:14px;text-transform:uppercase;border-right:0px solid rgba(0,0,0, .2);border-bottom:3px solid #b7b3ef;margin-bottom:-3px}.navbar .nav>li>a:hover{color:#3c469c;text-decoration:none;border-bottom:3px solid #3c469c}.navbar .nav li.dropdown.open > .dropdown-toggle, .navbar .nav li.dropdown.active > .dropdown-toggle, .navbar .nav li.dropdown.open.active>.dropdown-toggle{background-color:transparent;color:#fff}.navbar .btn-navbar, .navbar .btn-navbar:hover, .navbar .btn-navbar:active{background-color:#001e3c;background:#001e3c !Important}.nav-collapse.active{background:#fff;height:auto;top:6px}.navbar .pull-right
a{padding:4px
...
15px;border-bottom-width:1px !important}.navbar .nav>li>a{border-bottom:none !important;background:transparent !important;margin-bottom:0px}.nav .dropdown-menu li a:hover, .navbar .nav>li>a:hover{background:rgba(255,255,255,.1);color:#333}.dropdown-submenu:hover>a,.dropdown-submenu:focus>a{background:rgba(255,255,255,.1)}.dropdown-submenu>.dropdown-menu{top:0;left:100%;margin-top:-6px;margin-left:-1px}@media only screen and (min-width : 768px){.dropdown-menu .sub-menu{left:100%;position:absolute;top:0;visibility:hidden;margin-top:-1px}.dropdown-submenu>.dropdown-menu{display:none}.dropdown-menu li:hover .sub-menu{visibility:visible}.dropdown:hover>.dropdown-menu{display:block}}.nav-tabs .dropdown-menu, .nav-pills .dropdown-menu, .navbar .dropdown-menu{margin-top:0}.navbar .nav>li:last-child>a{border-right:0px !important}.dropdown .fa.fa-briefcase{padding-right:4px}.navbar .btn, .navbar .btn-group{margin-top:3px}@media (max-width: 979px){.hbl,.sbl,.hbll,.sbll{display:none !important}#navwrap{border-bottom:0}#page-header a
img{margin:0
...
solid #e8eaeb;margin-bottom:20px;background-color:#f5f5f5}.site-topic ul.section, .course-content
ul.section{margin:0em
1em}#newdiscussionform{text-align:right}#searchforums{margin:5px
0px 5px 5px}.course-content
.current{background-color:#d5e6fa !important;border-left:0px solid #ccc;border-right:0px dashed #ccc;margin-top:0px !important}.panel-body{overflow:hidden}.panel-body .courseimage
...
0;padding-top:12px}h3.sectionname{background:#032d5d;color:#fff;font-size:16px;font-weight:normal;margin-bottom:10px;margin-top:-12px;padding:0
...
a{width:30px;height:100%;display:block;position:absolute;top:0%;cursor:pointer;text-indent:-9999px;opacity:0;-webkit-transition:all .3s ease}.flex-direction-nav .flex-next{background:url(/elearning/theme/image.php/bcu/theme/1699952798/next) no-repeat 50% 50%;right:-25px;opacity: .5}.flex-direction-nav .flex-prev{background:url(/elearning/theme/image.php/bcu/theme/1699952798/previous) no-repeat 50% 50%;left:-25px;opacity: .5}.flexslider:hover .flex-next{opacity:1}.flexslider:hover .flex-prev{opacity:1}.flexslider:hover .flex-next:hover{opacity:1}.flexslider:hover .flex-prev:hover{opacity:1}.flex-direction-nav
.disabled{opacity: .3!important;filter:alpha(opacity=30);cursor:default}.image-slider .flex-direction-nav
a{opacity:0}.image-slider .flex-direction-nav .flex-next{background:#333 url(/elearning/theme/image.php/bcu/theme/1699952798/s_icon_next_w) no-repeat 50% 50%;right:0}.image-slider .flex-direction-nav .flex-prev{background:#333 url(/elearning/theme/image.php/bcu/theme/1699952798/s_icon_prev_w) no-repeat 50% 50%;left:0}.image-slider:hover .flex-next{opacity: .3}.image-slider:hover .flex-prev{opacity: .3}.flex-control-nav{width:100%;position:absolute;bottom:10px;text-align:center}.flex-control-nav
li{margin:0
...
a{font-size:110%;font-family:'Open Sans',sans-serif;font-weight:bold;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:80%;display:inline-block}.panel-body{padding:15px}ul.teachers{list-style-type:none;margin:0
0;padding:0
...
.discussioncontrol.movediscussion.movediscussion{float:left}.forumpost{background-color:#f5f5f5}#page-mod-forum-discuss .forumpost .row .left.picture img, #page-site-index .forumpost .row .left.picture
img{border:5px
...
.subject{font-size:1.8em;line-height:normal;font-weight:400;padding:6px
0 0 0}.forumpost
...
5px}.dropdown-menu.usermen{top:15px;margin-left:-15px}.usermen
...
input{background:#FFD000;text-shadow:none;box-shadow:none;border:0px;-webkit-border-radius:8px;-moz-border-radius:8px;border-radius:8px;background-size:100% 200%;color:#fff;cursor:pointer;padding:8px
...
12px;margin-bottom:0;font-size:14px;line-height:20px;color:#FFF;text-align:center;text-shadow:none;vertical-align:middle;cursor:pointer;background-color:#FFD000;border:1px
...
15px 8px}#notice .singlebutton + .singlebutton input, .submit.buttons input[name="cancel"]{background:#0084C2 !important;text-shadow:none}input[type="submit"]:hover, input[type="button"]:hover, #searchform_button:hover, a.submit:hover, #notice .singlebutton + .singlebutton input:hover, .submit.buttons input[name="cancel"]:hover,#page-login-index2 .forgetpass a:hover,.btn:hover,.btn:active{background-position:0 -100%;text-decoration:none !important;color:#fff;background-color:#FFD000}input[type="submit"]:focus, input[type="button"]:focus, #searchform_button:focus, a.submit:focus, #notice .singlebutton + .singlebutton input:focus, .submit.buttons input[name="cancel"]:focus,#page-login-index2 .forgetpass a:focus,.btn:focus,.btn:focus{background-position:0 -100%;text-decoration:none !important;color:#fff;background-color:#FFD000}button.close{background:transparent !important;text-shadow:none !Important;color:#000 !important;opacity:1 !important;box-shadow:none !important}#edittingbutton
.btn{color:#FFF}input.form-submit:hover, input#id_submitbutton:hover, input#id_submitbutton2:hover, .path-admin .buttons input[type="submit"]:hover, td.submit input:hover, input.form-submit:focus, input#id_submitbutton:focus, input#id_submitbutton2:focus, .path-admin .buttons input[type="submit"]:focus, td.submit input:focus, input.form-submit:active, input#id_submitbutton:active, input#id_submitbutton2:active, .path-admin .buttons input[type="submit"]:active, td.submit input:active, input.form-submit.active, input#id_submitbutton.active, input#id_submitbutton2.active, .path-admin .buttons input[type="submit"].active, td.submit input.active, input.form-submit.disabled, input#id_submitbutton.disabled, input#id_submitbutton2.disabled, .path-admin .buttons input[type="submit"].disabled, td.submit input.disabled, input.form-submit[disabled], input#id_submitbutton[disabled], input#id_submitbutton2[disabled], .path-admin .buttons input[type="submit"][disabled], td.submit input[disabled]{background-color:#FFD000;color:#fff}.bluebtn-color{background-color:#014ea6;border:0px;box-shadow:0 0 0 0}.fullwidth-btn{line-height:15px;border-radius:4px;width:100%;box-sizing:border-box}.bluebtn{line-height:15px;border-radius:4px;width:100%;box-sizing:border-box;background-color:#014ea6;border:0px;box-shadow:0 0 0 0;margin:5px
0px 5px!important}